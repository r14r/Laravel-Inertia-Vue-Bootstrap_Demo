  ...
  <ExampleLayout>
    ...
    <svg class="d-none" xmlns="http://www.w3.org/2000/svg">
      ...
      <symbol id="music-note-beamed" viewbox="0 0 16 16">
        ...
        <path d="M14 11V2h1v9h-1zM6 3v10H5V3h1z" fill-rule="evenodd"></path>
    ...
    <div class="d-flex flex-column flex-md-row p-4 gap-4 py-md-5 align-items-center justify-content-center">
      <div class="dropdown-menu d-block position-static pt-0 mx-0 rounded-3 shadow overflow-hidden w-280px"
        ...
        <form class="p-2 mb-2 bg-body-tertiary border-bottom">
          <input autocomplete="false" class="form-control" placeholder="Type to filter..." type="search" />
        </form>
      ...
      <div class="dropdown-menu d-block position-static border-0 pt-0 mx-0 rounded-3 shadow overflow-hidden w-280px"
        data-bs-theme="dark">
        <form class="p-2 mb-2 bg-dark border-bottom border-dark">
          <input autocomplete="false" class="form-control bg-dark" placeholder="Type to filter..." type="search" />
        </form>
        <ul class="list-unstyled mb-0">
          <li><a class="dropdown-item d-flex align-items-center gap-2 py-2" href="#">
              <span class="d-inline-block bg-success rounded-circle p-1"></span>
      ...
      <div
        ...
        <nav class="col-lg-8">
          <ul class="list-unstyled d-flex flex-column gap-2">
            <li>
              <a class="btn btn-hover-light rounded-2 d-flex align-items-start gap-2 py-2 px-3 lh-sm text-start"
                href="#">
        ...
        <div class="col-lg-auto pe-3">
          <nav>
            <ul class="d-flex flex-column gap-2 list-unstyled small">
              <li><a class="link-offset-2 link-underline link-underline-opacity-25 link-underline-opacity-75-hover"
                  href="#">Documentation</a></li>
              <li><a class="link-offset-2 link-underline link-underline-opacity-25 link-underline-opacity-75-hover"
                  href="#">Use cases</a></li>
              <li><a class="link-offset-2 link-underline link-underline-opacity-25 link-underline-opacity-75-hover"
                  href="#">API status</a></li>
              <li><a class="link-offset-2 link-underline link-underline-opacity-25 link-underline-opacity-75-hover"
                  href="#">Partners</a></li>
              <li><a class="link-offset-2 link-underline link-underline-opacity-25 link-underline-opacity-75-hover"
                  href="#">Resources</a></li>
