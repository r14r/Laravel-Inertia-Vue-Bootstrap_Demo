<style></style>
<template><body class="d-flex h-100 text-center text-bg-dark">
...
<a aria-current="page" class="nav-link fw-bold py-1 px-0 active" href="#">Home</a>
...
<p>Cover template for <a class="text-white" href="https://getbootstrap.com/">Bootstrap</a>, by <a class="text-white" href="https://twitter.com/mdo">@mdo</a>.</p>
</footer>
</div>
