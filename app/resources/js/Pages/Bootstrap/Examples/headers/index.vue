...
<svg aria-label="Bootstrap" class="bi" height="32" role="img" width="40"><use xlink:href="#bootstrap"></use></svg>
</a>
</div>
...
<svg aria-label="Bootstrap" class="bi me-2" height="32" role="img" width="40"><use xlink:href="#bootstrap"></use></svg>
</a>
<ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
<li><a class="nav-link px-2 text-secondary" href="#">Home</a></li>
<li><a class="nav-link px-2 text-white" href="#">Features</a></li>
<li><a class="nav-link px-2 text-white" href="#">Pricing</a></li>
<li><a class="nav-link px-2 text-white" href="#">FAQs</a></li>
<li><a class="nav-link px-2 text-white" href="#">About</a></li>
</ul>
<form class="col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3" role="search">
<input aria-label="Search" class="form-control form-control-dark text-bg-dark" placeholder="Search..." type="search"/>
</form>
<div class="text-end">
...
<div class="container">
<div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
<a class="d-flex align-items-center mb-2 mb-lg-0 link-body-emphasis text-decoration-none" href="/">
<svg aria-label="Bootstrap" class="bi me-2" height="32" role="img" width="40"><use xlink:href="#bootstrap"></use></svg>
</a>
<ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
<li><a class="nav-link px-2 link-secondary" href="#">Overview</a></li>
<li><a class="nav-link px-2 link-body-emphasis" href="#">Inventory</a></li>
<li><a class="nav-link px-2 link-body-emphasis" href="#">Customers</a></li>
<li><a class="nav-link px-2 link-body-emphasis" href="#">Products</a></li>
</ul>
<form class="col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3" role="search">
<input aria-label="Search" class="form-control" placeholder="Search..." type="search"/>
</form>
<div class="dropdown text-end">
<a aria-expanded="false" class="d-block link-body-emphasis text-decoration-none dropdown-toggle" data-bs-toggle="dropdown" href="#">
<img alt="mdo" class="rounded-circle" height="32" src="https://github.com/mdo.png" width="32"/>
</a>
...
<div class="dropdown">
<a aria-expanded="false" class="d-flex align-items-center col-lg-4 mb-2 mb-lg-0 link-body-emphasis text-decoration-none dropdown-toggle" data-bs-toggle="dropdown" href="#">
<svg class="bi me-2" height="32" width="40"><use xlink:href="#bootstrap"></use></svg>
</a>
<ul class="dropdown-menu text-small shadow">
<li><a aria-current="page" class="dropdown-item active" href="#">Overview</a></li>
...
<li class="nav-item"><a aria-current="page" class="nav-link link-body-emphasis px-2 active" href="#">Home</a></li>
<li class="nav-item"><a class="nav-link link-body-emphasis px-2" href="#">Features</a></li>
<li class="nav-item"><a class="nav-link link-body-emphasis px-2" href="#">Pricing</a></li>
<li class="nav-item"><a class="nav-link link-body-emphasis px-2" href="#">FAQs</a></li>
<li class="nav-item"><a class="nav-link link-body-emphasis px-2" href="#">About</a></li>
</ul>
<ul class="nav">
<li class="nav-item"><a class="nav-link link-body-emphasis px-2" href="#">Login</a></li>
<li class="nav-item"><a class="nav-link link-body-emphasis px-2" href="#">Sign up</a></li>
</ul>
</div>
</nav>
...
<svg class="bi d-block mx-auto mb-1" height="24" width="24"><use xlink:href="#home"></use></svg>
                Home
              </a>
</li>
<li>
<a class="nav-link text-white" href="#">
<svg class="bi d-block mx-auto mb-1" height="24" width="24"><use xlink:href="#speedometer2"></use></svg>
                Dashboard
              </a>
</li>
<li>
<a class="nav-link text-white" href="#">
<svg class="bi d-block mx-auto mb-1" height="24" width="24"><use xlink:href="#table"></use></svg>
                Orders
              </a>
</li>
<li>
<a class="nav-link text-white" href="#">
<svg class="bi d-block mx-auto mb-1" height="24" width="24"><use xlink:href="#grid"></use></svg>
                Products
              </a>
</li>
<li>
<a class="nav-link text-white" href="#">
<svg class="bi d-block mx-auto mb-1" height="24" width="24"><use xlink:href="#people-circle"></use></svg>
                Customers
              </a>
</li>
</ul>
...
<div class="text-end">
<button class="btn btn-light text-dark me-2" type="button">Login</button>
<button class="btn btn-primary" type="button">Sign-up</button>
</div>
</div>
</div>
