        ...
        <body>
                ...
                <div class="d-flex flex-column flex-md-row p-4 gap-4 py-md-5 align-items-center justify-content-center">
                        <div class="list-group">
                                <a aria-current="true" class="list-group-item list-group-item-action d-flex gap-3 py-3"
                                        href="#">
                                        <img alt="twbs" class="rounded-circle flex-shrink-0" height="32"
                                                src="https://github.com/twbs.png" width="32" />
                                        <div class="d-flex gap-2 w-100 justify-content-between">
                                                <div>
                                                        <h6 class="mb-0">List group item heading</h6>
                                                        <p class="mb-0 opacity-75">Some placeholder content in a
                                                                paragraph.</p>
                                                </div>
                                ...
                                <a aria-current="true" class="list-group-item list-group-item-action d-flex gap-3 py-3"
                                        ...
                                        <div class="d-flex gap-2 w-100 justify-content-between">
                                                <div>
                                                        ...
                                                        <p class="mb-0 opacity-75">Some placeholder content in a
                                                                paragraph that goes a little longer so it wraps to a new
                                                                line.</p>
                                                </div>
                ...
                <div class="d-flex flex-column flex-md-row p-4 gap-4 py-md-5 align-items-center justify-content-center">
                        <div class="list-group">
                                <label class="list-group-item d-flex gap-2">
                                        <input checked="" class="form-check-input flex-shrink-0" type="checkbox"
                                                value="" />
                                        <span>
                                                First checkbox
                                                <small class="d-block text-body-secondary">With support text underneath
                                                        to add more detail</small>
                                        </span>
                                </label>
                                <label class="list-group-item d-flex gap-2">
                                        ...
                                        <span>
                                                Second checkbox
                                                <small class="d-block text-body-secondary">Some other text goes
                                                        here</small>
                                        </span>
                                </label>
                                <label class="list-group-item d-flex gap-2">
                                        ...
                                        <span>
                                                Third checkbox
                                                <small class="d-block text-body-secondary">And we end with another
                                                        snippet of text</small>
                                        </span>
                                </label>
                        </div>
                        <div class="list-group">
                                <label class="list-group-item d-flex gap-2">
                                        <input checked="" class="form-check-input flex-shrink-0" id="listGroupRadios1"
                                                name="listGroupRadios" type="radio" value="" />
                                        <span>
                                                First radio
                                                <small class="d-block text-body-secondary">With support text underneath
                                                        to add more detail</small>
                                ...
                                <label class="list-group-item d-flex gap-2">
                                        <input class="form-check-input flex-shrink-0" id="listGroupRadios2"
                                                name="listGroupRadios" type="radio" value="" />
                                        <span>
                                                Second radio
                                                <small class="d-block text-body-secondary">Some other text goes
                                ...
                                <label class="list-group-item d-flex gap-2">
                                        <input class="form-check-input flex-shrink-0" id="listGroupRadios3"
                                                name="listGroupRadios" type="radio" value="" />
                                        <span>
                                                Third radio
                                                <small class="d-block text-body-secondary">And we end with another
                ...
                <div class="d-flex flex-column flex-md-row p-4 gap-4 py-md-5 align-items-center justify-content-center">
                        <div class="list-group">
                                <label class="list-group-item d-flex gap-3">
                                        <input checked="" class="form-check-input flex-shrink-0"
                                                style="font-size: 1.375em;" type="checkbox" value="" />
                                        <span class="pt-1 form-checked-content">
                                                <strong>Finish sales report</strong>
                                                <small class="d-block text-body-secondary">
                                                        <svg class="bi me-1" height="1em" width="1em">
                                ...
                                <label class="list-group-item d-flex gap-3">
                                        <input class="form-check-input flex-shrink-0" style="font-size: 1.375em;"
                                                type="checkbox" value="" />
                                        <span class="pt-1 form-checked-content">
                                ...
                                <label class="list-group-item d-flex gap-3 bg-body-tertiary">
                                        <input class="form-check-input form-check-input-placeholder bg-body-tertiary flex-shrink-0 pe-none"
                                                disabled="" style="font-size: 1.375em;" type="checkbox" value="" />
                                        <span class="pt-1 form-checked-content">
                                                <span class="w-100" contenteditable="true">Add new task...</span>
                                                <small class="d-block text-body-secondary">
                                                        <svg class="bi me-1" height="1em" width="1em">
                ...
                <div class="d-flex flex-column flex-md-row p-4 gap-4 py-md-5 align-items-center justify-content-center">
                        <div class="list-group list-group-checkable d-grid gap-2 border-0">
                                <input checked="" class="list-group-item-check pe-none" id="listGroupCheckableRadios1"
                                        name="listGroupCheckableRadios" type="radio" value="" />
                                ...
                                <input class="list-group-item-check pe-none" id="listGroupCheckableRadios2"
                                        name="listGroupCheckableRadios" type="radio" value="" />
                                ...
                                <input class="list-group-item-check pe-none" id="listGroupCheckableRadios3"
                                        name="listGroupCheckableRadios" type="radio" value="" />
                                <label class="list-group-item rounded-3 py-3" for="listGroupCheckableRadios3">
                                        Third radio
                                        <span class="d-block small opacity-50">And we end with another snippet of
                                                text</span>
                                </label>
                                <input class="list-group-item-check pe-none" disabled="" id="listGroupCheckableRadios4"
                                        name="listGroupCheckableRadios" type="radio" value="" />
                        ...
                        <div class="list-group list-group-radio d-grid gap-2 border-0">
                                <div class="position-relative">
                                        <input checked=""
                                                ...
                                                id="listGroupRadioGrid1" name="listGroupRadioGrid" type="radio"
                                                value="" />
                                        <label class="list-group-item py-3 pe-5" for="listGroupRadioGrid1">
                                                <strong class="fw-semibold">First radio</strong>
                                                <span class="d-block small opacity-75">With support text underneath to
                                                        add more detail</span>
                                        </label>
                                </div>
                                <div class="position-relative">
                                        <input class="form-check-input position-absolute top-50 end-0 me-3 fs-5"
                                                id="listGroupRadioGrid2" name="listGroupRadioGrid" type="radio"
                                                value="" />
                                ...
                                <div class="position-relative">
                                        <input class="form-check-input position-absolute top-50 end-0 me-3 fs-5"
                                                id="listGroupRadioGrid3" name="listGroupRadioGrid" type="radio"
                                                value="" />
                                        <label class="list-group-item py-3 pe-5" for="listGroupRadioGrid3">
                                                <strong class="fw-semibold">Third radio</strong>
                                                <span class="d-block small opacity-75">And we end with another snippet
                                                        of text</span>
                                        </label>
                                </div>
                                <div class="position-relative">
                                        <input class="form-check-input position-absolute top-50 end-0 me-3 fs-5"
                                                disabled="" id="listGroupRadioGrid4" name="listGroupRadioGrid"
                                                type="radio" value="" />
